#!/bin/bash
LOG_FILE="/home/luosx/.cursor/projects/home-luosx-3dgs/terminals/721546.txt" # New log file for the restarted process
TARGET_PID=85999 # PID of the new process
